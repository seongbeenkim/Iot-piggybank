...
var handleInteractiveChartMember = function (options) {
	"use strict";
	...
	if ($('#interactive-chart-member').length !== 0) {
        ...
        $.plot($("#interactive-chart-member"), [
            ...
            ],
            {
                ...
                yaxis: {  ticks: 10, tickColor: '#ddd', min: 0, max: 2000 },
                grid: {
                    hoverable: true,
                    clickable: true,
                    tickColor: "#ddd",
...
var StatisticsActivityMonth = function () {
	"use strict";
    return {
        //main function
        init: function (options, options2) {
            handleInteractiveChartMember(options);
            handleInteractiveChartStage(options2);
        }
    };
}();
