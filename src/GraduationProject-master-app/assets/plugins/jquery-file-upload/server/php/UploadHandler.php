...
//			'upload_url' => $this->get_full_url().'/files/',
			'upload_dir' => '/home/src/imin/upload/settings/',
			'upload_url' => 'http://img.iminfintech.co.kr/settings/',
			'user_dirs' => false,
			'mkdir_mode' => 0755,
			'param_name' => 'files',
	...
	protected function trim_file_name($file_path, $name, $size, $type, $error,
		...
		if(file_exists($this->options['upload_dir'].$name)) {
			...
			$iCnt = 1;
			while($bFlag != 1){
				if(!file_exists($this->options['upload_dir'].$sFileName.$iCnt.".".$sExt)){
					$bFlag = 1;
					$name=$sFileName.$iCnt.".".$sExt;
				}
				$iCnt++;
			}
		}
